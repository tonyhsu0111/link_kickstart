...
```
vmlinuz initrd=initrd.img inst.stage2=hd:LABEL=Rocky-8-9-x86_64-dvd inst.ks=https://raw.githubusercontent.com/tonyhsu0111/link_kickstart/refs/heads/develop/default_ks.cfg
```
